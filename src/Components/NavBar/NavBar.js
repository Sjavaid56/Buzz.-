        ...
        return (
            <div className="NavBar-parent">
                ...
                <div className="NavBar-parent__Map">
                    <button onClick={this.props.toggleMap} className="NavBar-parent__Hives--button2"><img className="NavBar-parent__Hives--logo2" src={map}></img></button>
                </div>
                <div className="NavBar-parent__Profile">
                    <button onClick={this.props.toggleProfileRespFn} className="NavBar-parent__Hives--button3"><img className="NavBar-parent__Hives--logo" src={profile}></img></button>
                </div>
            </div>
        )
    }
